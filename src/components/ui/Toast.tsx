...
import { CheckCircle2, Info, AlertTriangle, X } from "../../lib/icons";
          ...
          {toasts.map((t) => {
            ...
            return (
              <motion.div
                ...
                className="pointer-events-auto flex items-center gap-3 pl-3.5 pr-2 py-2.5 min-w-[260px] max-w-sm toast-lens"
              >
